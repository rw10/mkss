...
public class UserServiceJSONTest extends AbstractTestBase
{
    ...
    public void testInsert() throws IOException, JAXBException
    {
        ...
        String requestContent = 
                "{\"id\":0,\"username\":\"maggie\",\"password\":\"AZ2wv9X4WVHLRuRFLpZChYwAQVU=\"}";
    ...
    public void testFindAll() throws IOException, JAXBException
    {
        ...
        final String EXPECTED = "[" + "{\"id\":1,\"username\":\"homer\",\"password\":\"ijD8qepbRnIsva0kx0cKRCcYysg=\"},"
